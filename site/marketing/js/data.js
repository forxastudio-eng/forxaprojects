// Contenido semilla / de respaldo del Dashboard Forxa.
...
window.FORXA_DEFAULT_DATA = {
  "meta": {
    "eyebrow": "Forxa Inmobiliaria · Cuenca, Ecuador",
  ...
  "insights": [
    ...
    },
    {
      ...
      "type": "warn",
      "text": "**4 de 9 asesores no cerraron ninguna venta en agosto.** Andrea Cárdenas y Adrián Rodríguez concentran el 67% de los ingresos del mes."
    }
  ],
  "kpis": [
    {
  ...
  "asesores": {
    ...
    "note": "Andrea Cárdenas lidera agosto en ventas ($7,310) pero no registra captaciones en el año — vale la pena revisar si está trabajando solo cartera de proyectos. Pablo Calle es el más consistente en el acumulado (74.7% de meta anual) pese a un agosto modesto.",
  ...
  "social": {
    ...
    "note1": "TikTok es la red de mayor crecimiento (+54.8% seguidores) pero perdió alcance en impresiones (-36.9%, ver detalle por red en Metricool). Facebook sigue siendo la base más grande y estable (9,162 seguidores, 75% de la audiencia en Ecuador, 36% solo en Cuenca).",
    "inversionRows": [
      {
    ...
    "benchmarkRows": [
      {
        "name": "Leonel Ochoa Vintimilla",
        "widthPct": 100,
        "value": "2.98%",
        "self": false
      },
      {
        "name": "Cuenca Destino Para Vivir",
        "widthPct": 35,
        "value": "1.04%",
        "self": false
      },
      {
        "name": "Inmobiliaria Al Fin Hogar",
        "widthPct": 18,
        "value": "0.54%",
        "self": false
      },
      {
        "name": "RE/MAX Destiny Cuenca",
        "widthPct": 15,
        "value": "0.45%",
        "self": false
      },
      {
        "name": "Solbicon Inmobiliaria",
        "widthPct": 10,
        "value": "0.31%",
        "self": false
      },
      ...
      {
        "name": "Forxa Inmobiliaria",
        "widthPct": 5,
        "value": "0.16%",
        "self": true
      }
    ],
    "note3": "Forxa crece en seguidores más rápido que casi toda la competencia local, pero su **tasa de engagement (0.16%) está entre las más bajas** del set de competidores rastreado por Metricool — señal de que el contenido gana alcance pero no genera suficiente interacción activa."
  },
  "footer": {
    "fuentes": "Datos_Forxa_Inmobiliaria.xlsx (hojas \"Ventas\", \"Asesores por mes\" y detalle transaccional) · Social_Media_Insights_-_agosto.pdf (Metricool, periodo 01 ene–31 ago 2026).",
    ...
    "generado": "Generado el 2 de septiembre de 2026 · Dashboard preparado para dirección de marketing, Forxa Inmobiliaria."
  },
  "theme": {
    "primary1": "#1D62DB",
    "primary2": "#3C9FF4",
